  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.book.home.createOrEditLabel" data-cy="BookCreateUpdateHeading">
            <Translate contentKey="myApp.book.home.createOrEditLabel">Create or edit a Book</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('myApp.book.title')} id="book-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('myApp.book.description')}
                id="book-description"
                name="description"
                data-cy="description"
                type="text"
              />
              <ValidatedField
                label={translate('myApp.book.publicationDate')}
                id="book-publicationDate"
                name="publicationDate"
                data-cy="publicationDate"
                type="date"
              />
              <ValidatedField label={translate('myApp.book.price')} id="book-price" name="price" data-cy="price" type="text" />
              <ValidatedField id="book-author" name="author" data-cy="author" label={translate('myApp.book.author')} type="select">
                <option value="" key="0" />
                {authors
