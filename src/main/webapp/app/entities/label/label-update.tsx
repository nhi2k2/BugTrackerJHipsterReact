  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.label.home.createOrEditLabel" data-cy="LabelCreateUpdateHeading">
            <Translate contentKey="myApp.label.home.createOrEditLabel">Create or edit a Label</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('myApp.label.label')}
                id="label-label"
                name="label"
                data-cy="label"
                type="text"
