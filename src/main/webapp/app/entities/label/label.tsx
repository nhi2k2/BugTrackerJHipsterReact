  ...
  return (
    <div>
      <h2 id="label-heading" data-cy="LabelHeading">
        <Translate contentKey="myApp.label.home.title">Labels</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="myApp.label.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/label/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myApp.label.home.createLabel">Create new Label</Translate>
          </Link>
        </div>
      </h2>
        ...
        {labelList && labelList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="myApp.label.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="myApp.label.label">Label</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myApp.label.home.notFound">No Labels found</Translate>
            </div>
          )
        )}
      </div>
