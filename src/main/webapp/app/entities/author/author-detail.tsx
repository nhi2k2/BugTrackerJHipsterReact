    ...
    <Row>
      <Col md="8">
        <h2 data-cy="authorDetailsHeading">
          <Translate contentKey="myApp.author.detail.title">Author</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="myApp.author.name">Name</Translate>
            </span>
          </dt>
          <dd>{authorEntity.name}</dd>
          <dt>
            <span id="birthDate">
              <Translate contentKey="myApp.author.birthDate">Birth Date</Translate>
            </span>
          </dt>
          <dd>
