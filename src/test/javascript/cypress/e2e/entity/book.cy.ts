...
describe('Book e2e test', () => {
  ...
  describe('new Book page', () => {
    ...
    it('should create an instance of Book', () => {
      ...
      cy.get(`[data-cy="description"]`).type('Electronics extend').should('have.value', 'Electronics extend');

      cy.get(`[data-cy="publicationDate"]`).type('2023-09-21').blur().should('have.value', '2023-09-21');

      cy.get(`[data-cy="price"]`).type('5360').should('have.value', '5360');
